  ...
  return (
    ...
    >
      ...
      <p className="text-base md:text-lg mb-2 max-w-2xl mx-auto" style={{ color: COLORS.textSecondary }}>
        ...
        <span style={{ color: COLORS.brandSecondary }}> تقييمات دقيقة</span>، 
        ومحاكاة واقعية.
      </p>
      ...
      <div className="w-full p-6 rounded-2xl" style={{ backgroundColor: COLORS.cardBg, border: `1px solid ${COLORS.border}` }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <textarea
              placeholder="ملاحظاتك عن المشروع (اختياري)"
              rows="3"
              className="w-full p-3 pr-12 rounded-xl outline-none transition-all resize-none"
              style={{ backgroundColor: COLORS.background, color: COLORS.text, border: `1px solid ${COLORS.border}` }}
